...
| [publish.yml](./.github/workflows/publish.yml)                     | Runs the tests, creates a Git tag and publishes to the [NeoForge maven](https://maven.neoforged.net/).                                                                                                                                                                                                                                                                                                                                                                                   |
| [build.yml](./.github/workflows/build.yml)                         | Runs for pushes and pull requests. Essential for PR publishing as well as publishing SNAPSHOT versions to the [NeoForge snapshot maven repository](https://maven.neoforged.net/snapshots/).                                                                                                                                                                                                                                                                                              |
